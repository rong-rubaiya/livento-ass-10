      ...
      <div className="relative z-10 max-w-3xl mx-auto bg-[#F3F4F6] px-4 py-8 rounded-4xl">
        ...
        <form className="space-y-4 ">
          ...
          <div className=''>
            ...
            <select className="w-full p-4   placeholder:text-gray-400  border-2 border-black focus:border-none focus:outline-none focus:ring-2 focus:ring-[#EC6325]  rounded-xl">
